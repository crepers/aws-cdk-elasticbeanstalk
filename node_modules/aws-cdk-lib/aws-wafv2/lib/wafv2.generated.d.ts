...
export interface CfnLoggingConfigurationProps {
     ...
     */
    readonly loggingFilter?: CfnLoggingConfiguration.LoggingFilterProperty | cdk.IResolvable;
    /**
...
export declare class CfnLoggingConfiguration extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafv2-loggingconfiguration.html#cfn-wafv2-loggingconfiguration-loggingfilter
     */
    loggingFilter: CfnLoggingConfiguration.LoggingFilterProperty | cdk.IResolvable | undefined;
    /**
     * The parts of the request that you want to keep out of the logs. For example, if you redact the `SingleHeader` field, the `HEADER` field in the logs will be `xxx` .
     *
     * > You can specify only the following fields for redaction: `UriPath` , `QueryString` , `SingleHeader` , `Method` , and `JsonBody` .
...
export declare namespace CfnLoggingConfiguration {
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly jsonBody?: CfnLoggingConfiguration.JsonBodyProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly singleHeader?: CfnLoggingConfiguration.SingleHeaderProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnRuleGroup {
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly singleHeader?: CfnRuleGroup.SingleHeaderProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly singleQueryArgument?: CfnRuleGroup.SingleQueryArgumentProperty | cdk.IResolvable;
        /**
         * Inspect the request URI path. This is the part of the web request that identifies a resource, for example, `/images/daily-ad.jpg` .
         *
...
export declare namespace CfnRuleGroup {
    ...
    interface RuleActionProperty {
         ...
         */
        readonly allow?: CfnRuleGroup.AllowProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly block?: CfnRuleGroup.BlockProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly captcha?: CfnRuleGroup.CaptchaProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly count?: CfnRuleGroup.CountProperty | cdk.IResolvable;
    }
}
export declare namespace CfnRuleGroup {
    /**
...
export declare namespace CfnWebACL {
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly singleHeader?: CfnWebACL.SingleHeaderProperty | cdk.IResolvable;
        /**
         * Inspect a single query argument. Provide the name of the query argument to inspect, such as *UserName* or *SalesRegion* . The name can be up to 30 characters long and isn't case sensitive.
         *
         * Example JSON: `"SingleQueryArgument": { "Name": "myArgument" }`
         ...
         */
        readonly singleQueryArgument?: CfnWebACL.SingleQueryArgumentProperty | cdk.IResolvable;
        /**
         * Inspect the request URI path. This is the part of the web request that identifies a resource, for example, `/images/daily-ad.jpg` .
         *

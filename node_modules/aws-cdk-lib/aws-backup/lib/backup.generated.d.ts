...
export declare namespace CfnBackupSelection {
    ...
    interface BackupSelectionResourceTypeProperty {
         ...
         */
        readonly conditions?: CfnBackupSelection.ConditionsProperty | cdk.IResolvable;
        /**
...
export declare namespace CfnFramework {
    ...
    interface FrameworkControlProperty {
         ...
         */
        readonly controlScope?: CfnFramework.ControlScopeProperty | cdk.IResolvable;
    }
}
/**
...
export interface CfnReportPlanProps {
     ...
     */
    readonly reportDeliveryChannel: CfnReportPlan.ReportDeliveryChannelProperty | cdk.IResolvable;
    /**
     ...
     */
    readonly reportSetting: CfnReportPlan.ReportSettingProperty | cdk.IResolvable;
    /**
...
export declare class CfnReportPlan extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-reportplan.html#cfn-backup-reportplan-reportdeliverychannel
     */
    reportDeliveryChannel: CfnReportPlan.ReportDeliveryChannelProperty | cdk.IResolvable;
    /**
     * Identifies the report template for the report. Reports are built using a report template. The report templates are:
     *
     * `RESOURCE_COMPLIANCE_REPORT | CONTROL_COMPLIANCE_REPORT | BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT`
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-reportplan.html#cfn-backup-reportplan-reportsetting
     */
    reportSetting: CfnReportPlan.ReportSettingProperty | cdk.IResolvable;
    /**
     * An optional description of the report plan with a maximum 1,024 characters.
     *
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-reportplan.html#cfn-backup-reportplan-reportplandescription
